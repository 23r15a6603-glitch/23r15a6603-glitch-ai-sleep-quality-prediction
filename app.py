...
<script>
  ...
  sendBtn.addEventListener("click", () => {
    ...
    setTimeout(() => {
      ...
      else if (m.includes("temperature") || m.includes("room")) reply = "🌡 Ideal sleep environment: <br>1. Keep your room cool (18–22°C) <br>2. Use blackout curtains <br>3. Reduce noise with earplugs/white noise.";
      ...
      else if (m.includes("mental health") || m.includes("anxiety")) reply = "❤ Mental health & sleep: <br>1. Journaling before bed can reduce racing thoughts <br>2. Try mindfulness or gratitude practice <br>3. Seek help if anxiety regularly affects sleep.";
      else if (m.includes("light")) reply = "☀ Light & sleep: <br>1. Get sunlight in the morning <br>2. Keep evenings dim to trigger melatonin <br>3. Use blackout curtains for deep sleep.";
      ...
      else if (m.includes("pillows") || m.includes("bed")) reply = "🛏 Bed comfort: <br>1. Choose a supportive mattress <br>2. Replace old pillows regularly <br>3. Keep bedding clean & cozy.";
